                  ...
                  <div class="col-lg-12 main-chart">
						...
						<div class="modal-view">
							<table class="table table-bordered table-striped" id="example1">
								...
								<tfoot>
									<tr>
										<th colspan="5">Total Semua Barang </td>
										<th><?php echo $totalStok;?></td>
										<th>Rp.<?php echo number_format($totalBeli);?>,-</td>
										<th>Rp.<?php echo number_format($totalJual);?>,-</td>
										<th colspan="2" style="background:#0bb365">Keuntungan Rp.<?php echo number_format($totalUntung);?>,-</th>
									</tr>
								</tfoot>
							</table>
						</div>
									...
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												...
												<td>SKU</td>
												<td><input type="text" required class="form-control" name="id">*Harap diperhatikan SKU tidak boleh sama !
													<br>Contoh : Sp.Kt100T20.001(sudah ada) - Sp.Kt100T20.002(benar)</td>
											</tr>
											<tr>
												<td>Kategori</td>
												<td>
											...
											<tr>
												<td>Nama Barang</td>
												<td><input type="text" placeholder="Nama Barang" onkeyup="isi_otomatis()" id="nama_barang" required class="form-control" name="nama"></td>
											</tr>
											<tr>
												<td>kondisi Barang</td>
												<td><input type="text" placeholder="kondisi Barang" required class="form-control" id="kondiai" name="kondisi"></td>
											</tr>
											<tr>
												<td>Harga Beli</td>
												<td><input type="number" placeholder="Harga beli" required class="form-control" id="harga_beli" name="beli"></td>
											</tr>
											<tr>
												<td>Harga Jual</td>
												<td><input type="number" placeholder="Harga Jual" required class="form-control" id="harga_jual" name="jual"></td>
											</tr>
											<tr>
												<td>Satuan Barang</td>
												<td>
